...
class StateMachine:
    def __init__(self, initial_state: Type[State], *args, **kwargs):
        """Create a state machine.

        Args:
            initial_state: The first state to be used.
            *args: Arguments to be passed to the initial state.
            **kwargs: Keyword arguments to be passed to the initial state.
        """
        self._state: Union[State, None] = None
        self.stack: List[State] = []
        self.state = (StateOperations.PUSH, initial_state(*args, **kwargs))
